...
int SW_blue = 2;   //(in my case) blue push button for menu
...
MCP.begin();
  ...
  /*
  MCP4725 has two mods;  
   1. setValue(value) = Uses writeFastMode and does not write to EEPROM
  2. writeDAC(value, const bool EEPROM = false) =  Writes to DAC and conditionally to EEPROM.*/
  MCP.ready();
  delay(30);
